...
1. In this section, we will look at _type hints_. Type hints are a way to annotate your Python code with information about the expected types of variables, function arguments, and return values.  
